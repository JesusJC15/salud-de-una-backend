...
Capacidades transversales reutilizables en toda la API.

## Archivos actuales

- (sin archivos de codigo directos en esta carpeta)

## Dependencias relacionadas

- decorators, enums, filters, guards, interceptors, interfaces, utils
